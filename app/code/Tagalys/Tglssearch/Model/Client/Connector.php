<?php
namespace Tagalys\Tglssearch\Model\Client;
...
class Connector extends \Magento\Framework\Model\AbstractModel {
	...
	protected function _construct() 
	{
		...
		/* $this->_api_server = $this->scopeConfig->getValue('server/search/hostname', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		$this->_api_key = $this->scopeConfig->getValue('server/search/key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		
		$this->_create_or_update_ep = $this->scopeConfig->getValue('search/endpoint/create_or_update', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		$this->_search_ep = $this->scopeConfig->getValue('search/endpoint/search', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		$this->_delete_ep = $this->scopeConfig->getValue('search/endpoint/delete', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		$this->_search_suggestions_ep = $this->scopeConfig->getValue('search/endpoint/search_suggestions', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		$this->_merchandising_ep = $this->scopeConfig->getValue('search/endpoint/merchandising', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
		$this->_similar_products_ep = $this->scopeConfig->getValue('search/endpoint/similar_products', \Magento\Store\Model\ScopeInterface::SCOPE_STORE); */
