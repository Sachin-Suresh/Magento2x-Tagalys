...
class Product extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
     ...
     * @return $this
     */
   /*  public function deleteEntity()https://www.google.co.in/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&ved=0ahUKEwig0MemytzOAhWJMY8KHUKyDsAQFggdMAA&url=http%3A%2F%2Fmagento.stackexchange.com%2Fquestions%2F132148%2Fworking-of-the-saveproductentity-for-saving-entity-ids-magento2&usg=AFQjCNFRW-w0UCScDaXHhxJ9lJxCja62NA&sig2=hWqBwJNcZR3qE1KeFeoPQg&bvm=bv.130731782,d.c2I&cad=rja
    {
        $listTitle = [];
        ...
        if ($table && $listTitle) {
                try {
                    $this->countItemsDeleted += $this->_connection->delete(
                        ...
                        $this->_connection->quoteInto('product_id IN (?)', $listTitle)
                    );
                    return true;
                } catch (\Exception $e) {
                    return false;
